...
public class ModelChampions {
    ...
    // Constructor vacío
    public ModelChampions() {}

    // Constructor con todos los atributos
    public ModelChampions(int idEquipo, String nombre, String pais, String ciudad, String estadio, int fundacion, String entrenador,
                          String webOficial, String facebook, String twitter, String instagram, String patrocinadorPrincipal, Timestamp creadoEn) {
